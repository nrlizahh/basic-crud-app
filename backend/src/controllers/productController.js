const {getProducts, createProduct, getProductById, editProduct, deleteProduct} = require('../models/productModel');
...
module.exports = { listProducts, detailProduct, createNewProduct, updatedProduct, deleteProductById };